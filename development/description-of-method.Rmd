...
\\
4       & & 4      & &  2      & &  0      & & \opro_B &  &  \epsilon(1-p_A)(1-p_B)                          &   &  (1-p_A)(1-p_B) \\
4       & & 4      & &  2      & &  1      & & \opro_B &  &  (1-\epsilon)(1-p_B) + \epsilon[p_A(1-p_B) + p_B(1-p_A)]         &   &  p_A(1-p_B) + p_B(1-p_A) \\
4       & & 4      & &  2      & &  2      & & \opro_B &  &  (1-\epsilon)p_B + \epsilon p_Ap_B        &   &  p_Ap_B \\
\end{aligned}
$$
\end{table}
