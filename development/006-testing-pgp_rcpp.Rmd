...
So, everything is checking out on debug == 0.  Let's continue sussing things out.
...
under cases when different ancestries are being segregated from the parent.  


## Debug == 3. Probabilities conditional on the segregated haplotype from the parent

Here we need to check both the SOS probabilities and the genotype probabilities.  
